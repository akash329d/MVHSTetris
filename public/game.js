...
class TetrisGame {
	...
	spawnPowerUps(amount){
	    ...
	    var blocksAvailable = [];
	    //var powerUps = ["addLine", "clearLine", "switch", "earthquake", "nuke", "randomClear", "darkness"];
	    var powerUps = ["addLine", "clearLine", "switch", "nuke", "darkness", "invertedControls", "randomClear"];
	    for(var x = 0; x < 20; x++){
        for(var p = 0; p < 10; p++){
	...
	handlePower(data){
	    switch(data[0]){
            ...
            case "I":
                ...
                KEY.ARROWUP = 40;
                setTimeout(function() {
                    KEY = { ESC: 27, SPACE: 32, LEFT: 65 , UP: 87, RIGHT: 68, DOWN: 83, ARROWLEFT: 37, ARROWDOWN: 40, ARROWUP: 38, ARROWRIGHT: 39, ONE: 49, TWO: 50, THREE: 51, FOUR: 52, FIVE: 53};
                }, 5000);
                break;
            case "E":
                /*var lineCount = 0;
            ...
            case "R":
                ...
                for (var l = 0; l < 5; l++) {
                	if (blocksAvailable.length != 0) {
                		this.boardStatic[blocksAvailable[l].xPos][blocksAvailable[l].yPos] = 0;
                	}
                }
                break;
        }
